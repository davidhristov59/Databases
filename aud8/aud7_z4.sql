...
SELECT AVG(p.PRICE * o.QUANTITY) AS AVG_PRICE
...
WHERE o.PARTNUM = P.PARTNUM
GROUP BY o.PARTNUM
--Дополнително да се отфрлат сите шифри на производи за кои вкупната сума е помала или еднаква на просечната остварена продажба за тој ПРОИЗВОД.
